...
print("PEN-AND-PAPER ANALYSIS:")
print("Mathematical analysis of SVM objective function for different C values:")
print()
print("SVM Objective Function: min (1/2)||w||² + C∑ξᵢ")
print("subject to: yᵢ(w^T xᵢ + b) ≥ 1 - ξᵢ, ξᵢ ≥ 0")
print()
print("Margin width = 2/||w||")
print("Larger ||w|| → smaller margin")
print("Smaller ||w|| → larger margin")
print()
print("Analysis of relative term importance:")
print()
print("C = 0.1 (Very Small):")
print("- Regularization term (1/2)||w||² dominates")
print("- Ratio: Regularization/Penalty = (1/2)||w||²/(0.1∑ξᵢ)")
print("- To minimize objective: minimize ||w||² (maximize margin)")
print("- Many ξᵢ > 0 are tolerated (more slack allowed)")
print("- Result: Large margin, many support vectors")
print()
print("C = 1 (Moderate):")
print("- Balanced weighting: (1/2)||w||² vs 1×∑ξᵢ")
print("- Neither term dominates completely")
print("- Moderate trade-off between margin and violations")
print("- Result: Moderate margin, balanced support vectors")
print()
print("C = 10 (Large):")
print("- Penalty term 10×∑ξᵢ has more influence")
print("- Ratio: Regularization/Penalty = (1/2)||w||²/(10∑ξᵢ)")
print("- To minimize objective: reduce ∑ξᵢ (fewer violations)")
print("- Smaller margin acceptable to reduce slack")
print("- Result: Smaller margin, fewer support vectors")
print()
print("C = 100 (Very Large):")
print("- Penalty term 100×∑ξᵢ dominates")
print("- Strong pressure to make ξᵢ → 0")
print("- Approaches hard margin: yᵢ(w^T xᵢ + b) ≥ 1")
print("- Result: Minimal margin, minimal support vectors")
print()
print("Mathematical prediction: Margin width ∝ 1/√C (approximately)")
print()
...
print("PEN-AND-PAPER ANALYSIS:")
print("Mathematical derivation of bias-variance tradeoff relationship:")
print()
print("Decomposition of Expected Test Error:")
print("E[(y - f̂(x))²] = σ² + Bias²[f̂(x)] + Var[f̂(x)]")
print("where σ² is irreducible error (noise)")
print()
print("For SVM with regularization parameter C:")
print()
print("Bias Analysis:")
print("Bias²[f̂(x)] = (E[f̂(x)] - f*(x))²")
print("where f*(x) is the true function")
print()
print("Small C → High Regularization:")
print("- Objective emphasizes (1/2)||w||² term")
print("- Forces w toward 0, simpler decision boundary")
print("- E[f̂(x)] may be far from f*(x)")
print("- High Bias: Bias²[f̂(x)] ↑")
print()
print("Large C → Low Regularization:")
print("- Objective emphasizes C∑ξᵢ term")
print("- Allows larger ||w||, more complex boundary")
print("- E[f̂(x)] closer to f*(x)")
print("- Low Bias: Bias²[f̂(x)] ↓")
print()
print("Variance Analysis:")
print("Var[f̂(x)] = E[(f̂(x) - E[f̂(x)])²]")
print()
print("Small C → High Regularization:")
print("- Constraint: ||w|| ≤ R for some R")
print("- Limited parameter space reduces sensitivity")
print("- Low Variance: Var[f̂(x)] ↓")
print()
print("Large C → Low Regularization:")
print("- Larger parameter space, more degrees of freedom")
print("- Model sensitive to training data variations")
print("- High Variance: Var[f̂(x)] ↑")
print()
print("Mathematical Relationship:")
print("d(Bias²)/dC < 0  (bias decreases with C)")
print("d(Var)/dC > 0    (variance increases with C)")
print("Optimal C: d(Bias² + Var)/dC = 0")
print()
...
print("PEN-AND-PAPER ANALYSIS:")
print("Mathematical analysis of support vector count vs C:")
print()
print("Support Vector Definition:")
print("Point xᵢ is a support vector if:")
print("1. yᵢ(w^T xᵢ + b) = 1 - ξᵢ  (constraint is active)")
print("2. αᵢ > 0 in dual formulation")
print()
print("From KKT conditions:")
print("αᵢ[yᵢ(w^T xᵢ + b) - 1 + ξᵢ] = 0")
print("μᵢξᵢ = 0, where μᵢ = C - αᵢ ≥ 0")
print()
print("Classification of support vectors:")
print("1. Margin support vectors: ξᵢ = 0, 0 < αᵢ < C")
print("   yᵢ(w^T xᵢ + b) = 1 (exactly on margin)")
print("2. Non-margin support vectors: ξᵢ > 0, αᵢ = C")
print("   yᵢ(w^T xᵢ + b) = 1 - ξᵢ < 1 (inside margin)")
print()
print("Mathematical Analysis:")
print()
print("Small C:")
print("- Many points can have αᵢ = C (slack allowed)")
print("- Larger margin → more points inside margin")
print("- More non-margin support vectors")
print("- Total support vectors = margin SVs + non-margin SVs ↑")
print()
print("Large C:")
print("- High penalty forces ξᵢ → 0")
print("- Fewer points can violate margin")
print("- Smaller margin → fewer points inside margin")
print("- Mostly margin support vectors only")
print("- Total support vectors ↓")
print()
print("Asymptotic behavior:")
print("As C → ∞: ξᵢ → 0 ∀i")
print("Only margin support vectors remain")
print("Number converges to hard margin SVM count")
print()
print("Theoretical bound:")
print("Number of support vectors ≤ min(n, d+1)")
print("where n = sample size, d = feature dimension")
print()
...
print("PEN-AND-PAPER ANALYSIS:")
print("Mathematical framework for optimal C selection:")
print()
print("Objective: Minimize expected generalization error")
print("E_test = E_D[(y - f̂_D(x))²]")
print("where D is training data, f̂_D is learned function")
print()
print("Cross-Validation Estimator:")
print("CV_k(C) = (1/k) ∑ᵢ₌₁ᵏ L(f̂_Dᵢ(C), D_val_i)")
print("where Dᵢ = training fold i, D_val_i = validation fold i")
print("L = loss function (e.g., 0-1 loss for classification)")
print()
print("Theoretical Justification:")
print("By law of large numbers: CV_k(C) → E_test(C) as k → ∞")
print("For finite k: E[CV_k(C)] ≈ E_test(C)")
print()
print("Optimal C Selection:")
print("C* = argmin_C CV_k(C)")
print()
print("Algorithm Design:")
print("1. C Range: Logarithmic grid C = {10^i : i ∈ [-3, 3]}")
print("   Rationale: SVM objective scales multiplicatively with C")
print()
print("2. Grid Resolution: Δ(log C) = 0.3 (about 20 points)")
print("   Balances computational cost vs precision")
print()
print("3. Cross-validation: k = 5 or k = 10")
print("   k = 5: Lower variance, higher bias")
print("   k = 10: Higher variance, lower bias")
print("   Bias-variance tradeoff in CV itself")
print()
print("4. Performance Metric:")
print("   Classification: Accuracy = 1 - (1/n)∑I(yᵢ ≠ ŷᵢ)")
print("   Alternative: F1-score for imbalanced data")
print()
print("5. Overfitting Detection:")
print("   Gap = Train_accuracy - CV_accuracy")
print("   Large gap indicates overfitting")
print("   Select C with small gap and high CV accuracy")
print()
print("6. Statistical Significance:")
print("   Standard error: SE = σ/√k")
print("   Select C within one SE of best CV score")
print()
...
print("PEN-AND-PAPER ANALYSIS:")
print("Rigorous mathematical proof of convergence C → ∞:")
print()
print("THEOREM: lim_{C→∞} (w*, b*, ξ*)_soft = (w*, b*)_hard")
print("where (w*, b*, ξ*)_soft solves soft margin SVM")
print("and (w*, b*)_hard solves hard margin SVM")
print()
print("PROOF:")
print()
print("Step 1: Problem Formulations")
print("Soft Margin (P_soft):")
print("  min_{w,b,ξ} J_C(w,b,ξ) = (1/2)||w||² + C∑ᵢξᵢ")
print("  s.t. yᵢ(w^T xᵢ + b) ≥ 1 - ξᵢ, ξᵢ ≥ 0 ∀i")
print()
print("Hard Margin (P_hard):")
print("  min_{w,b} (1/2)||w||²")
print("  s.t. yᵢ(w^T xᵢ + b) ≥ 1 ∀i")
print()
print("Step 2: Sequence Analysis")
print("Let {C_k} be a sequence with C_k → ∞")
print("Let (w_k, b_k, ξ_k) be optimal solution for C = C_k")
print()
print("Claim: ∑ᵢξᵢ_k → 0 as k → ∞")
print()
print("Proof of Claim:")
print("Suppose ∑ᵢξᵢ_k ≥ ε > 0 for infinitely many k")
print("Then J_{C_k}(w_k,b_k,ξ_k) ≥ (1/2)||w_k||² + C_k·ε")
print("As C_k → ∞, this diverges to ∞")
print()
print("But consider feasible point (w_0, b_0, 0) where")
print("(w_0, b_0) is hard margin solution (assuming it exists)")
print("Then J_{C_k}(w_0,b_0,0) = (1/2)||w_0||² (constant)")
print()
print("Since (w_k,b_k,ξ_k) is optimal:")
print("J_{C_k}(w_k,b_k,ξ_k) ≤ J_{C_k}(w_0,b_0,0) = (1/2)||w_0||²")
print()
print("This contradicts divergence, so ∑ᵢξᵢ_k → 0")
print()
print("Step 3: Constraint Convergence")
print("From ξᵢ_k → 0 and ξᵢ_k ≥ 0:")
print("yᵢ(w_k^T xᵢ + b_k) ≥ 1 - ξᵢ_k → 1")
print()
print("Since (w_k,b_k,ξ_k) satisfies soft margin constraints:")
print("yᵢ(w_k^T xᵢ + b_k) ≥ 1 - ξᵢ_k")
print("Taking limit: yᵢ(w*^T xᵢ + b*) ≥ 1")
print("This is exactly the hard margin constraint")
print()
print("Step 4: Objective Convergence")
print("J_{C_k}(w_k,b_k,ξ_k) = (1/2)||w_k||² + C_k∑ᵢξᵢ_k")
print("Since ∑ᵢξᵢ_k → 0 and C_k∑ᵢξᵢ_k remains bounded:")
print("lim_{k→∞} J_{C_k}(w_k,b_k,ξ_k) = (1/2)||w*||²")
print()
print("This equals the hard margin objective")
print()
print("Step 5: Uniqueness and Convergence")
print("Since hard margin solution is unique (under non-degeneracy):")
print("(w_k, b_k) → (w*_hard, b*_hard)")
print()
print("QED: Soft margin SVM converges to hard margin SVM as C → ∞")
print()
