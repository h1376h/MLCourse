...
The FDA requires that a medication demonstrate at least 12mmHg reduction with 80% probability. We need to calculate $P(y_{new} \geq 12 | x_{new} = 35mg)$ and check if it's $\geq 0.80$.
...
$$P(y_{new} \geq 12|x_{new} = 35mg) = P(Z \geq -2.6965) = 1 - P(Z \leq -2.6965) = 1 - \Phi(-2.6965) = 1 - 0.0035 = 0.9965$$

Since $0.9965 \geq 0.80$, the 35mg dose meets the FDA requirement with a substantial margin.
...
This plot illustrates the Normal predictive distribution for the blood pressure reduction ($y_{new}$) at a dosage of $x_{new} = 35mg$. The distribution is $\mathcal{N}(14.35, 0.76)$. The mean prediction is marked, along with the FDA's 12mmHg threshold. The shaded area represents $P(y_{new} \geq 12mmHg)$, which is 0.9965, satisfying the FDA requirement.
...
- A 35mg dose meets the FDA requirement, as $P(y_{new} \geq 12mmHg | x_{new}=35mg) = 0.9965$, which is greater than the required 0.80.
