...
### Problem Statement
Consider training a 5th-degree polynomial regression on a dataset generated by a quadratic function with some noise.

#### Task
1. In the diagram below, sketch the general shape of the training error and validation error curves as functions of the regularization parameter $\lambda$ (from very small to very large):

![Regularization Plot](../Images/L3_7_Quiz_25/regularization_paths.png)

2. Mark and label the region of underfitting, optimal fitting, and overfitting on your diagram.
3. For very small values of $\lambda$, explain why the training error is low but validation error is high.
4. For very large values of $\lambda$, explain why both training and validation errors are high.
5. If you had to choose between slightly underfitting and slightly overfitting your model, which would you choose and why?
6. How would your diagram change if the underlying data was actually generated by a 5th-degree polynomial instead of a quadratic function?
