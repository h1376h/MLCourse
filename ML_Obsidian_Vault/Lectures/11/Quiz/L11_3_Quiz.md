...
5. For three clusters $C_1=\{(0,0), (1,0)\}$, $C_2=\{(3,0)\}$, $C_3=\{(0,3), (1,3)\}$, calculate the Ward distances for all possible merges ($C_1\cup C_2$, $C_1\cup C_3$, $C_2\cup C_3$) and determine which merge minimizes the increase in total within-cluster sum of squares. 
