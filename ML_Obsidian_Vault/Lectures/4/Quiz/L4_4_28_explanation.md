...
2. Calculate the output: $f = \text{sign}(w_1x_1 + w_2x_2 + b)$
3. If $y \cdot f \leq 0$ (misclassification), update the weights:
...
$$w_1x_1 + w_2x_2 + b = 0 \cdot 8 + 0 \cdot 2 + 0 = 0$$

Step 2: Determine the predicted class using $\text{sign}(w_1x_1 + w_2x_2 + b)$
$$\text{sign}(0) = 0$$

Step 3: Check if an update is needed by calculating $y \cdot (w_1x_1 + w_2x_2 + b)$
$$y \cdot (w_1x_1 + w_2x_2 + b) = 1 \cdot 0 = 0$$

Step 4: Update weights if $y \cdot (w_1x_1 + w_2x_2 + b) \leq 0$
...
For SourOranges:
- Point 1: $x - \mu_2 = [3, 8] - [2.50, 7.50] = [0.50, 0.50]$
  $(x - \mu_2)(x - \mu_2)^T = \begin{bmatrix} 0.25 & 0.25 \\ 0.25 & 0.25 \end{bmatrix}$
- Point 2: $x - \mu_2 = [2, 7] - [2.50, 7.50] = [-0.50, -0.50]$
  $(x - \mu_2)(x - \mu_2)^T = \begin{bmatrix} 0.25 & 0.25 \\ 0.25 & 0.25 \end{bmatrix}$
...
$$\mu_1 - \mu_2 = [7.50, 2.50] - [2.50, 7.50] = [5.00, -5.00]$$
...
$$\|w\| = \sqrt{5.0^2 + (-5.0)^2} = \sqrt{50} = 7.071$$
$$w_{normalized} = \frac{w}{\|w\|} = \frac{1}{7.071} \begin{bmatrix} 5.0 \\ -5.0 \end{bmatrix} = \begin{bmatrix} 0.7071 \\ -0.7071 \end{bmatrix}$$
...
$$w[0] = 2.0 \times 5.0 + 0.0 \times (-5.0) = 10.0$$
$$w[1] = 0.0 \times 5.0 + 2.0 \times (-5.0) = -10.0$$
$$w = \begin{bmatrix} 10.0 \\ -10.0 \end{bmatrix}$$

Normalize the vector:
$$\|w\| = \sqrt{10.0^2 + (-10.0)^2} = \sqrt{200} = 14.142$$
$$w_{normalized} = \frac{w}{\|w\|} = \frac{1}{14.142} \begin{bmatrix} 10.0 \\ -10.0 \end{bmatrix} = \begin{bmatrix} 0.7071 \\ -0.7071 \end{bmatrix}$$
...
$$\text{midpoint} = \frac{\mu_1 + \mu_2}{2} = \frac{[7.50, 2.50] + [2.50, 7.50]}{2} = [5.00, 5.00]$$

For a line perpendicular to vector $[0.7071, -0.7071]$ passing through $[5.00, 5.00]$, the equation is:
$$-0.7071(x - 5.00) - 0.7071(y - 5.00) = 0$$

Simplifying:
$$-0.7071x - 0.7071y = -7.071$$
...
- **Fisher's LDA**:
  ...
  - In our case, the optimal direction [0.7071, -0.7071] aligns perfectly with the intuitive decision boundary
