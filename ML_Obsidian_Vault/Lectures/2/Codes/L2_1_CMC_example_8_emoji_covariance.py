...
def emoji_covariance_example():
    ...
    print("- Positive correlation makes data 'happy' because variables 'agree' with each other (in a linear sense)")
    print("- Negative correlation makes data 'sad' because variables 'disagree' with each other (in a linear sense)")
    print("- Zero correlation is 'emotionless' data - variables show no linear relationship")
    print("- Our emoji data shows *patterns*, but linear correlation might not fully capture the U-shape/inverted U-shape.")
    ...
    print("- Highlights that linear correlation measures *linear* association, and visual patterns can be non-linear.")
