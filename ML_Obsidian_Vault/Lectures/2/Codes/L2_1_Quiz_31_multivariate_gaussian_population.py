...
plot_data_with_ellipses(ax1b, class0_data, class1_data, mean_class0, mean_class1, 
                       cov_class0, cov_class1, new_point=new_point,
                       title='Data Points with Mean Vectors and Covariance Ellipses')
save_figure(fig1b, "a_step1b_data_scatter.png")
...
plt.tight_layout()
save_figure(fig2c, "a_step2c_gaussian_pdfs.png")
...
save_figure(fig3b, "a_step3b_equal_priors_classification.png")
...
save_figure(fig4b, "a_step4b_unequal_priors_classification.png")
...
plt.tight_layout()
save_figure(fig5a, "a_step5a_comparison.png")
